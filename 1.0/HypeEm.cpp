...
void calculator() {
    ...
    if (!(std::cin >> num1)) {
        std::cerr << "Error: Invalid input for the first number. Exiting..." << std::endl;
        return;
    }
    ...
    if (!(std::cin >> num2)) {
        std::cerr << "Error: Invalid input for the second number. Exiting..." << std::endl;
        return;
    }
...
void hangmanGame() {
    ...
    while (true) {
        ...
        if (!(std::cin >> guess)) {
            std::cerr << "Error: Invalid input for the letter. Exiting..." << std::endl;
            return;
        }
...
int main() {
    ...
    while (true) {
        ...
        if (!(std::cin >> command)) {
            std::cerr << "Error: Invalid input. Exiting..." << std::endl;
            return 1;
        }
        ...
        if (command == "help") {
            ...
            printf("HypeEm 1.0 Build Diamond x86 (Win32/Spider32) \n");
            ...
            std::cerr << "Error: \'" << command << "\' is an invalid command." << std::endl;
        }
    }
